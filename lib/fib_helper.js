...
FibHelper.setCurrentDOM = function() {
...
FibHelper.getFullJSONDir = function () {
  return FibHelper.resourcesDir + FibHelper.getJSONDir()
}
...
FibHelper.getFullImagesDir = function() {
  return FibHelper.resourcesDir + FibHelper.getImagesDir()
}
...
FibHelper.exportPNG = function ( obj, name ) {
  ...
  fw.exportDocumentAs( newDOM, FibHelper.getFullImagesDir() + name + '.png',
    null )

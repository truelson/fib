...
FibHelper.createFibHelper = function( dom, resourceDir ) {
  ...
  fibHelper.outputWarnings = function() {
    ...
    var fullFile = Files.makePathFromDirAndFile(
      fibHelper.resourceDir + '../', filename )
    ...
    alert( 'You have warnings.\r\rWe have saved all warnings to file:\r'
      + fullFile + '\r\r'
      + 'The first warning was: \r\r' + warnings[0] )
  }

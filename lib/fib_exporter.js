...
FibExporter.exportDOM = function ( dom, resourceDir ) {

  if( !dom ) return false

  var fibHelper = FibHelper.createFibHelper( dom, resourceDir )
...
FibExporter.exportPage = function() {
  ...
  FibExporter.exportDOM( fw.getDocumentDOM(), resourceDir )

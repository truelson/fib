...
FibExtractor.createFibExtractor = function( fibHelper ) {
  ...
  fibExtractor.shouldExtractVectorAsImage = function( fireworksObject ) {
    ...
    if (fireworksObject.effectList &&
        fireworksObject.effectList.effects &&
        fireworksObject.effectList.effects.length > 0) {
  ...
  fibExtractor.extractDummy = function( fireworksObject, outObject) {
    return null
  }
  ...
  fibExtractor.extractTextField = function( fireworksObject, outObject ) {
    ...
    outObject = fibExtractor.extractSimpleRectangle( fireworksObject,
      outObject )
  ...
  fibExtractor.extractTable = function( fireworksObject, outObject ) {
  ...
  fibExtractor.extractSimpleRectangle =
    function( fireworksObject, outObject, parent ) {
      ...
      if( fireworksObject.roundness ) {
        outObject.cornerRadius = fireworksObject.roundness
      }
  ...
  fibExtractor.fireworksExtractorTypeSetup = function() {
    ...
    newExtractor.dummy = fibExtractor.extractDummy

    newExtractor.image = fibExtractor.extractImage

    newExtractor.freeImage = fibExtractor.extractFreeImage

    newExtractor.textField = fibExtractor.extractTextField

    newExtractor.textArea = fibExtractor.extractTextArea
    newExtractor.textView = fibExtractor.extractTextArea

    newExtractor.table = fibExtractor.extractTable
  ...
  fibExtractor.fireworksExtractorType.Group =
    function( fireworksObject, parent ) {
      ...
      groupExtractor.scroll = groupExtractor.view
  ...
  fibExtractor.fireworksExtractorType.RectanglePrimitive =
    function( fireworksObject, parent ) {
      ...
      rectangleExtractor.graph = fibExtractor.extractSimpleRectangle
  ...
  fibExtractor.fireworksExtractorType.Path =
    function( fireworksObject, parent ) {
      ...
      pathExtractor.graph = fibExtractor.extractSimpleRectangle
  ...
  fibExtractor.fireworksExtractorType.Text =
    function( fireworksObject, parent ) {
      ...
      textExtractor.textView = textExtractor.textField

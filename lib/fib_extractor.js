...
FibExtractor.extractorType.RectanglePrimitive =
  function( fireworksObject, parent ) {
    ...
    var rectangleExtractor = FibExtractor.extractorTypeSetup()
...
FibExtractor.extractorType.Path = function( fireworksObject, parent ) {
  ...
  var isImage = FibExtractor.extractVectorAsImage( fireworksObject )

  var pathExtractor = FibExtractor.extractorTypeSetup()
  ...
  if ( typeof outObject.type === 'canvas' && isImage ) {
    alert( outObject.id + ' cannot be a canvas.  Making it an image.' )
...
FibExtractor.extractorType.Text = function( fireworksObject, parent ) {
  ...
  var textExtractor = FibExtractor.extractorTypeSetup()
